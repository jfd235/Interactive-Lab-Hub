...
For my experimentation, I well set the device on the ground next to a where a door meets the doorframe on the side opposite from the hinges. I will constantly be reading and outputting volume levels, and will test closing the door at what I feel to be a respectful volume. After some experimenting with volume levels, I'll determine a good threshold that can alert the user. Once I have this set in the code, I'll simply test closing the door softly and loudly at different intervals, and will see if the device can properly pickup on the times where the threshold was exceded.
