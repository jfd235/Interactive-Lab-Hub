...
I implemented threshold detection here:

[thresholdDetection.py](thresholdDetection.py)
...
We've all been in a situation where we're trying to pay attention in class, at a movie theatre, a library, or somewhere else and somebody is being loud and annoying. This can be frustrating since this always seems to break my focus, and ends up being all I can think about. What if there was someway to quantify and regulate this behavior? That's what I hope to explore with my prototype. Specifically, I plan to narrow this down to determine doors are being closed to hard. Students leave/enter classrooms during class all the time, and people leave/enter libraries and theatres often. But sometimes they let the door slam behind them, which can be distracting to everyone else. My device would mount next to a doorframe, and would read the volume of the door being closed. If the volume is above a certain "respectful" threshold, it would alert the person entering/exiting that they are a nuisance, hopefully putting pressure on them to do better next time.

For my experimentation, I set the device on the ground next to a where a door meets the doorframe on the side opposite from the hinges. I constantly read and printed out volume levels, and I tested closing the door at what I feel to be a respectful volume. After some experimenting with volume levels, I determined a good threshold that can alert the user. Once I had this set in the code, I simply tested closing the door softly and loudly at different intervals, and saw if the device could properly pickup on the times where the threshold was exceded.
...
https://drive.google.com/file/d/1ib7zWAYLfKSr09ZMfKM2g_DkrhRDsrin/view?usp=sharing

### Part 2.

Following exploration and reflection from Part 1, finish building your interactive system, and demonstrate it in use with a video.

When trying to come up with a better way to interact between the user and the device, I thought of the goal of the device: get people to close doors more quietly. How was I achieving this? I used the red light to scare them or make them feel ashamed. What's a much better deterrent than either of those things? That's right: emberassment! Thus I updated the device to play some embarassing sounds when the volume threshold was broken. It took a bit of Python gymnastics to make sure only one sound played instead of throughout the duration of the volume buffer having the maximum value, but I got it to work like a charm. In the video below, we can set the scene: you're trying to watch a movie with your friends and your annoying roommate keeps coming to the kitchen and slamming the refrigerator door, totally killing the vibe. With this in place, your roommate will finally grab his food in a respectul manner out of crippling fear of being embarassed in front of all of your friends, and you can finally watch your Netflix in peace! In the video I close the refrigerator door with some force a few times, then a bit softer for a few times, and finally I close it hard again, and the device responds accordingly. I hope you enjoy!

P.S. Wendy if you'd like to install this device in the classroom for lectures I'd be happy to tweak the code so that the device is triggered by the door closing after a certain time (8:20am) for a small commission.

**\*\*\*Include a short video demonstrating the finished result.\*\*\***

https://drive.google.com/file/d/18THegu7b6Mh8VR5NfnD2iIxBNR7t4SsH/view?usp=sharing
